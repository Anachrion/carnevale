...
void main() {
  testWidgets('GameHomeScreen renders the current user\'s games from the API', (tester) async {
    ...
    adapter.stub(
      'GET',
      '/games',
      listBody<api.Game>([fakeGame(name: 'Midnight Duel')], const FullType(api.Game)),
    );
