...
void main() {
  testWidgets('Score tab shows scenario, turn, score, and the hand for an in-progress game', (
    tester,
  ) async {
    ...
    adapter.stub('GET', '/games/1/players/2/list', modelListBody(fakeModelList()));
  ...
  testWidgets('offers End game on the last turn and opens the per-player log', (
    ...
    final opponent = fakeGamePlayer(id: 2, userId: 2, username: 'rival', host: false);
    final game = fakeGame(
      id: 1,
      status: api.GameStatusEnum.inProgress,
      players: [me, opponent],
