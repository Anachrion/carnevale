...
**role** | **String** |  | 
**agendasConfirmed** | **bool** | True once the player has confirmed their opening Agenda hand (agenda_draw phase). Both players confirming takes the game straight to in_progress. | 
