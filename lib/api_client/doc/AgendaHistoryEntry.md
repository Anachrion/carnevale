...
**turn** | **int** |  | 
**action** | **String** |  | 
**origin** | **String** | Why this event happened. Always null for `scored` events — scoring just resolves the Agenda's own printed condition, it isn't granted by an external rule the way drawing/discarding mid-game is. | 
