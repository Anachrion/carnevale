...
class GamesApi {
  ...
  Future<Response<DrawAgendasResponse>> drawAgendas({ 
    required int id,
    required DrawAgendaInput drawAgendaInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(drawAgendaInput, specifiedType: _type);
    ...
    DrawAgendasResponse? _responseData;
    ...
    return Response<DrawAgendasResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<AvailableGang>>> getAvailableGangs({ 
    ...
    BuiltList<AvailableGang>? _responseData;
    ...
    return Response<BuiltList<AvailableGang>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [visibility] - Which of the current user's games to return.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<BuiltList<Game>>> getGames({ 
    ...
    return Response<BuiltList<Game>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [EntryState] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EntryState>> updateSpellCast({ 
    required int id,
    required int listEntryId,
    required UpdateSpellCastInput updateSpellCastInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/games/{id}/entries/{list_entry_id}/spell_casts'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString()).replaceAll('{' r'list_entry_id' '}', encodeQueryParameter(_serializers, listEntryId, const FullType(int)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpdateSpellCastInput);
      _bodyData = _serializers.serialize(updateSpellCastInput, specifiedType: _type);
