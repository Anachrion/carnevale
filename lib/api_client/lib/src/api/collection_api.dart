...
class CollectionApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<CollectionItem>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CollectionItem>>> getCollection({ 
    ...
    BuiltList<CollectionItem>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(CollectionItem)]),
      ) as BuiltList<CollectionItem>;
    ...
    return Response<BuiltList<CollectionItem>>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<CollectionItem>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<CollectionItem>>> updateCollection({ 
    required CollectionBulkInput collectionBulkInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CollectionBulkInput);
      _bodyData = _serializers.serialize(collectionBulkInput, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CollectionItem] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CollectionItem>> updateCollectionItem({ 
    required int profileId,
    required CollectionItemInput collectionItemInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/collection/{profile_id}'.replaceAll('{' r'profile_id' '}', encodeQueryParameter(_serializers, profileId, const FullType(int)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CollectionItemInput);
      _bodyData = _serializers.serialize(collectionItemInput, specifiedType: _type);
    ...
    CollectionItem? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CollectionItem),
      ) as CollectionItem;
