...
part 'agenda_history_entry_agenda.g.dart';
...
class _$AgendaHistoryEntryAgendaSerializer implements PrimitiveSerializer<AgendaHistoryEntryAgenda> {
  ...
  void _deserializeProperties(
    ...
    required AgendaHistoryEntryAgendaBuilder result,
  ...
  @override
  AgendaHistoryEntryAgenda deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AgendaHistoryEntryAgendaBuilder();
