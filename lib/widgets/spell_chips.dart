...
void showSpellDetailDialog(BuildContext context, Spell spell) {
  showDialog(
    context: context,
    builder: (context) => ThemedDialogCard(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '${disciplineLabel(spell.discipline)}  ·  WP ${spell.cost}  ·  Difficulty ${spell.difficulty}',
...
List<Widget> spellChipsFor(ListEntry entry) {
  return [
